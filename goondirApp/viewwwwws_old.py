    ...
    if request.method == 'POST':
        ...
        for data in imported_data:
            ...
            patient_device_information_model=PatientDeviceInformation(
                ...
                blood_glucose_monitor=patient_model_id,
                patieoxymeter_IDnt_ID=oxymeter_model_id,
...
def patient_create(request):
    ...
    context['form'] = form
    return render(request, "../templates/goondirApp/patient/create.html", context)
...
def patient_edit(request, pk):
    ...
    if form.is_valid():
        ...
        return redirect('patients_list')
    context = {"form": form}
    return render(request, "../templates/goondirApp/patient/edit.html", context)
